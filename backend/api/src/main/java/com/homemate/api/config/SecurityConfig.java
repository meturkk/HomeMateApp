...
import com.homemate.api.security.CustomUserDetailsService;
import com.homemate.api.security.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .cors(cors -> cors.configurationSource(request -> {
                ...
                config.setAllowedOrigins(List.of("http://localhost:3000")); // Next.js Frontend URL
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/uploads/**").permitAll() // Yüklenen fotoğraflar herkese açık
                ...
                .anyRequest().authenticated() // Kalan uçlar Token zorunlu
            )
